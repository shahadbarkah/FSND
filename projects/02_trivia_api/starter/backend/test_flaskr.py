...
class TriviaTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.new_question = {'question': ' Early photographers made\
                             their images on which of these materials?',
                             'answer': 'Glass', 'difficulty': 2, 'category': 5}
    ...
    def test_quizze(self):
        next_question = {'quiz_category': {"type": "History", "id": 4},
    ...
    def test_422_test_quizze(self):
        next_question = {'quiz_category': {"type": "History", "id": 'aaa'},
                         'previous_questions': ["2"]}
        res = self.client().post('/quizzes', json=next_question)
        data = json.loads(res.data)
